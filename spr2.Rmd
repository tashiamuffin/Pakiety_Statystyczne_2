...
geom_line(aes(d, (mat[2,] - mat[3,]), color="welch -wc")) + geom_line(aes(d, (mat[1,] - mat[3,]), color="t-wc")) +
ggtitle("Różnice między mocami") + labs(x="d", y ="dpower") +
theme(plot.title = element_text(hjust = 0.5)) + guides(color = guide_legend(title = "test"))
ggsave("111.jpg", p)
```
...
geom_line(aes(d, (mat3[2,] - mat3[3,]), color="welch -wc")) + geom_line(aes(d, (mat3[1,] - mat3[3,]), color="t-wc")) +
ggtitle("Różnice między mocami") + labs(x="d", y ="dpower") +
theme(plot.title = element_text(hjust = 0.5)) + guides(color = guide_legend(title = "test"))
ggsave("311.jpg", p)
```
